      ...
      <div className="bg-gray-50 flex flex-col font-inter justify-start mx-auto pb-[17px] w-full">
        <div className="flex flex-col items-center w-full">
          <div className="sm:h-[1726px] h-[1825px] md:h-[3007px] md:px-5 relative w-full">
            <div className="absolute bottom-[0] flex flex-col items-center justify-start max-w-[1515px] right-[0] w-full">
            ...
            <Text
              className="absolute bg-white-A700 border-b border-gray-200 border-solid h-[50px] justify-center max-w-[1514px] md:max-w-full sm:px-5 px-[35px] py-3 right-[0] text-blue_gray-900 text-xl top-[3%] w-full"
...
export default DashboardProfileOnePage;
