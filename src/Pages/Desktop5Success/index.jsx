...
const Desktop5SuccessPage = () => {
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-zonapro items-center justify-start mx-auto pb-[30padpx] w-full">
        <div className="flex flex-col gap-10 items-center justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row font-inter mt-[95px] gap-5 items-center justify-start max-w-[1300px] mx-auto md:px-5 w-full">
