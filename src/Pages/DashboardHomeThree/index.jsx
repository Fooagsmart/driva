...
const DashboardHomeThreePage = () => {
  const tableData = React.useRef([
    {
      sn: "1",
      fullname: "John Doe",
      emailaddress: "johndoe01@gmail.com",
      phonenumber: "08168422954",
      houseaddress: "24, Estate Avenue, Norwegian, Alaska.",
      ...
      tableColumnHelper.accessor("row", {
        cell: (info) => (
          <div className="flex flex-row items-center justify-end p-4">
            <div className="bg-white-A700 border-2 border-gray-200 border-solid h-5 my-[5px] rounded w-5"></div>
          </div>
        ),
        header: (info) => (
          <div className="flex flex-row items-center justify-end min-w-[72px] p-3.5">
            <div className="bg-white-A700 border-2 border-gray-200 border-solid h-5 rounded w-5"></div>
          </div>
        ),
      }),
          ...
          <div className="flex flex-row items-center justify-center pr-3 py-3">
            <Button
              ...
              rightIcon={
                <Img
                  className="h-5 ml-1"
                  src="images/img_arrow_right_2.svg"
                  alt="Arrow - Right 2"
                />
              }
              shape="round"
  ...
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-zonapro items-center justify-start mx-auto pb-[180px] w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          <DashboardHomeOneSidebar className="bg-white-A700 border-gray-200 border-r border-solid flex flex-col gap-[18px] h-[963px] md:h-auto items-start justify-start mb-[728px] md:px-5 w-[214px]" />
          <div className="flex md:flex-1 flex-col font-inter items-start justify-start md:px-5 w-[88%] md:w-full">
            ...
            <div className="flex flex-col items-center justify-start ml-10 md:ml-[0] mt-5 w-auto">
              <Text
            ...
            <div className="bg-white-A700 border border-gray-200 border-solid flex flex-col gap-[18px] items-start justify-start ml-10 md:ml-[0] mt-5 py-5 rounded-lg w-[59%] md:w-full">
              <div className="flex flex-col gap-1 items-start justify-start px-5 w-auto md:w-full">
                <div className="flex flex-row gap-4 items-center justify-start w-auto">
                  ...
                  <div className="flex flex-row gap-1 items-center justify-start pb-[18px] w-auto">
              ...
              <div className="flex flex-col items-start justify-start px-5 w-auto sm:w-full">
                <Input
                  name="inputframe"
                  placeholder="Search applications"
                  value={inputframevalue}
                  onChange={(e) => setInputframevalue(e)}
                  className="!placeholder:text-blue_gray-900 !text-blue_gray-900 p-0 text-left text-sm w-full"
              ...
              <div className="overflow-auto w-full">
                <ReactTable
                  ...
                  rowClass={"bg-white-A700 border border-gray-200"}
                  headerClass="bg-gray-100"
                />
              </div>
              <div className="border-gray-200 border-solid border-t flex md:flex-col flex-row gap-5 items-center justify-start max-w-[893px] pt-5 px-5 w-full">
                <div className="flex flex-1 flex-row gap-3 items-center justify-start w-full">
                  ...
                  <SelectBox
                    className="border border-gray-200 border-solid sm:flex-1 font-medium rounded-md text-left text-sm w-[10%] sm:w-full"
