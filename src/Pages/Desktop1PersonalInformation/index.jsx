    ...
    <>
      <div className="bg-gray-50 flex flex-col font-zonapro items-center justify-start mx-auto pb-[30px] w-full">
        <div className="flex  flex-col gap-10 items-center justify-start w-full">
          <div className="bg-white-A700 fixed border-b border-blue_gray-100 border-solid flex flex-col items-center justify-start p-[13px] z-30 w-full">
          ...
          <div className="flex md:flex-col flex-row font-inter gap-5 items-start justify-start max-w-[1300px] mx-auto md:px-5 mt-[95px] w-full">
