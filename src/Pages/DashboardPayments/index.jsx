      ...
      <div className="bg-gray-50 flex flex-col font-zonapro items-center justify-start mx-auto pb-[17px] w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex md:flex-1 flex-col font-inter items-center justify-start md:px-5 w-[88%] md:w-full">
            ...
            <div className="bg-white-A700 border border-gray-200 border-solid flex flex-col h-[499px] md:h-auto items-start justify-start max-w-[1434px] mt-3 py-5 rounded-lg w-full">
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col items-center justify-start my-0 w-full">
                    <div className="bg-gray-50 border border-gray-200 border-solid flex flex-col items-start justify-start rounded-lg w-full">
                      <div
                        className="common-pointer flex md:flex-col flex-row gap-3 items-center justify-start px-5 py-2 rounded-lg w-full"
                        onClick={() => navigate("/dashboardpaymentsone1")}
                      >
                        <div className="flex flex-1 flex-col items-center justify-start w-full">
                          <div className="flex flex-col items-start justify-center w-full">
                            <Text
